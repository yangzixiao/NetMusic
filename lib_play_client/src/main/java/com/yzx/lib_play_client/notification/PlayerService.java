...
package com.yzx.lib_play_client.notification;
...
import com.yzx.lib_play_client.helper.PlayerCallHelper;
...
//    private DownloadUseCase mDownloadUseCase;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Music results = PlayerManager.getInstance().getCurrentPlayingMusic();
        if (results == null) {
            stopSelf();
...
//    private void createNotification(Music testMusic) {
//        try {
//            String title = testMusic.getTitle();
//            Album album = PlayerManager.getInstance().getAlbum();
